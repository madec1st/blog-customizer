...
export const Article = ({ articleStyles }: ArticleProps) => {
	const newStyles = {
		fontFamily: articleStyles.fontFamilyOption,
		fontSize: articleStyles.fontSizeOption,
	...
	return (
		<article className={clsx(styles.article)} style={newStyles}>
